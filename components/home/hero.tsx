...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-neutral-50 to-white px-4 pt-16 pb-6 dark:from-neutral-950 dark:to-neutral-900 sm:px-6 lg:px-8">
